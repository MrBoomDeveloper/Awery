...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.awery.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.awery.connections.anilist.api.Media?
        )
    }
    ...
    data class Page(
        ...
        data class Data(
            @SerialName("Page")
            val page: ani.awery.connections.anilist.api.Page?
        )
    }
...
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.awery.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.awery.connections.anilist.api.Studio?
        )
    }
...
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.awery.connections.anilist.api.MediaListCollection?
        )
    }
