...
import com.mrboomdev.awery.resources.readAsset
...
class PlatformSetting(
	...
	companion object {
		...
		suspend fun fromAssets(path: String) =
			json.decodeFromString<PlatformSetting>(readAsset(path)).apply { restoreValues() }
	}
}