...
import ani.awery.download.manga.MangaServiceDataSingleton
import ani.awery.media.Media
import ani.awery.media.MediaDetailsActivity
import ani.awery.media.MediaDetailsViewModel
import ani.awery.media.manga.mangareader.ChapterLoaderDialog
import ani.awery.parsers.DynamicMangaParser
import ani.awery.parsers.HMangaSources
import ani.awery.parsers.MangaParser
import ani.awery.parsers.MangaSources
import ani.awery.settings.UserInterfaceSettings
import ani.awery.settings.extensionprefs.MangaSourcePreferencesFragment
import ani.awery.subcriptions.Notifications
import ani.awery.subcriptions.Notifications.Group.MANGA_GROUP
import ani.awery.subcriptions.Subscription.Companion.getChannelId
import ani.awery.subcriptions.SubscriptionHelper
import ani.awery.subcriptions.SubscriptionHelper.Companion.saveSubscription
