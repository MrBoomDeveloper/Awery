...
@Suppress("FunctionName")
fun LazyListScope.MediaRouteWatch(args: MediaRoute, viewModel: MediaRouteViewModel) {
	items(viewModel.episodes) {
		
	}
	
	item("loading_episodes") {
...
class MediaRouteViewModel(
	...
	private val _episodes = mutableStateListOf<CatalogVideoFile>()
	...
	var episodesStatus: EpisodesStatus = EpisodesStatus.NotInitialized
		private set
	
	sealed interface EpisodesStatus {
		data object NotInitialized: EpisodesStatus
	}
